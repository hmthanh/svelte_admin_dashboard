...
<aside
  class="fixed inset-y-0 left-0 flex-wrap items-center justify-between block w-full p-0 my-4 overflow-y-auto transition-all duration-200 ease-in-out
  -translate-x-full bg-white border-0 shadow-none xl:ml-6 dark:bg-slate-850 z-990 max-w-64 rounded-2xl xl:translate-x-0"
  id="sidenav-main"
>
  <div class="h-20">
    <i
    ...
    >
      <img
        src="https://demos.creative-tim.com/argon-dashboard-pro-tailwind/assets/img/logo-ct-dark.png"
        class="inline-block h-full max-w-full transition-all duration-200 ease-in-out max-h-8 dark:hidden"
        alt="main_logo"
      />
      <img
        src="https://demos.creative-tim.com/argon-dashboard-pro-tailwind/assets/img/logo-ct.png"
        class="hidden h-full max-w-full transition-all duration-200 ease-in-out max-h-8 dark:inline-block"
        alt="main_logo"
      />
      <span class="ml-1 font-semibold transition-all duration-200 ease-in-out"
    ...
    <ul class="flex flex-col pl-0 mb-0 list-none">
      <li class="mt-0.5 w-full">
        ...
        >
          ...
          >
            <i class="text-sm leading-normal text-blue-500 ni ni-shop" />
          </div>

          <span
            class="ml-1 duration-300 opacity-100 pointer-events-none ease dark:text-white text-slate-700"
            >Dashboards</span
          >
        </a>
        <div
        ...
        >
          ...
          >
            <li class="w-full">
              <a
                class="ease-in-out py-2.7 ml-5.4 pl-4 leading-default text-sm relative my-0 mr-2 flex items-center whitespace-nowrap bg-transparent pr-4 font-medium text-slate-800/50 shadow-none transition-colors  dark:text-white dark:opacity-60"
            ...
            <li class="w-full">
              ...
              >
                ...
                <span
                  class="transition-all duration-100 pointer-events-none ease"
                >
                  Virtual Reality <b class="caret" /></span
                >
              </a>
              <div
              ...
              >
                ...
                >
                  <li class="w-full">
                    <a
                      class="ease-in-out py-2.7 ml-5.4 pl-4 text-3.2 relative my-0 mr-2 flex items-center whitespace-nowrap bg-transparent pr-4 font-medium text-slate-800/50 shadow-none transition-colors dark:text-white dark:opacity-60"
      ...
      <li class="mt-0.5 w-full">
        ...
        >
          <div
            class="stroke-none flex h-8 w-8 items-center justify-center rounded-lg bg-center fill-current p-2.5 text-center text-black"
          >
            <i class="text-sm leading-normal text-orange-500 ni ni-ungroup" />
          </div>
      ...
      <li class="mt-0.5 w-full">
        ...
        >
          <div
            class="stroke-none flex h-8 w-8 items-center justify-center rounded-lg bg-center fill-current p-2.5 text-center text-black"
          >
            <i class="text-sm leading-normal ni ni-ui-04 text-cyan-500" />
          </div>
          <span class="ml-1 duration-300 opacity-100 pointer-events-none ease"
            >Applications</span
          >
            ...
            <li class="w-full">
              ...
              >
                ...
                <span
                  class="transition-all duration-100 pointer-events-none ease"
                >
                  Reset Password <b class="caret" /></span
                >
              </a>
              <div
                class="h-auto overflow-hidden transition-all duration-200 ease-in-out max-h-0"
            ...
            <li class="w-full">
              ...
              >
                ...
                <span
                  class="transition-all duration-100 pointer-events-none ease"
                >
                  Getting Started <b class="caret" /></span
                >
              </a>
              <div
                class="h-auto overflow-hidden transition-all duration-200 ease-in-out max-h-0"
      ...
      <li class="mt-0.5 w-full">
        ...
        >
          <div
            class="stroke-none flex h-8 w-8 items-center justify-center rounded-lg bg-center fill-current p-2.5 text-center text-black"
          >
            <i class="text-sm leading-normal ni ni-app text-slate-700/80" />
          </div>
          <span class="ml-1 duration-300 opacity-100 pointer-events-none ease"
            >Components</span
          >
  ...
  <div class="mx-4 my-4">
    ...
    >
      <img
        class="w-3/5 mx-auto"
        src="https://demos.creative-tim.com/argon-dashboard-pro-tailwind/assets/img/illustrations/icon-documentation.svg"
    ...
    <a
      ...
      target="_blank"
      rel="noreferrer"
      class="inline-block w-full px-8 py-2 mb-4 text-xs font-bold leading-normal text-center text-white capitalize transition-all ease-in rounded-lg
      shadow-md bg-slate-700 bg-150 hover:shadow-xs hover:-translate-y-px"
      >Documentation</a
    >
  </div>
</aside>
